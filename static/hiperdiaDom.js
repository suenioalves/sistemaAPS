...
export const hiperdiaDom = {
    ...
    initDomElements: () => {
        ...
        _elements.emAvaliacaoCard = document.getElementById('emAvaliacaoCard');
        _elements.aguardandoExamesCard = document.getElementById('aguardandoExamesCard');
        _elements.semAvaliacaoCard = document.getElementById('semAvaliacaoCard');
