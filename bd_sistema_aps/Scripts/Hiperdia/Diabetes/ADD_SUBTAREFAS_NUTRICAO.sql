-- ================================================================
-- ADICIONAR SUBTAREFAS PARA ENCAMINHAMENTO À NUTRIÇÃO
-- ================================================================
-- Este script adiciona as subtarefas da ação cod_acao = 8
-- "Encaminhar para Nutrição"
-- ================================================================
...
-- Adicionar subtarefas para ações cod_acao = 8 já existentes (se houver)
...
WHERE a.cod_acao = 8  -- Encaminhar para Nutrição
  AND t.cod_acao = 8
  AND NOT EXISTS (
...
-- Verificar quantas subtarefas existem para cod_acao = 8
SELECT
    a.cod_acompanhamento,
    a.cod_cidadao,
    a.data_agendamento,
