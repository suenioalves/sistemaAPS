SELECT  
    ...
    CEIL(AVG(CAST(split_part(tam.nu_medicao_pressao_arterial, '/', 1) AS NUMERIC))) || 'x' || 
    CEIL(AVG(CAST(split_part(tam.nu_medicao_pressao_arterial, '/', 2) AS NUMERIC))) AS pressao_arterial
FROM tb_cidadao tc
